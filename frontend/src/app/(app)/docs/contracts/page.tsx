    ...
    <div className="max-w-3xl space-y-12">
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-atala/10">
            <span className="text-xs font-bold text-atala font-mono">V</span>
          </div>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={fn} className="border-b border-border/20 last:border-0">
                      <td className="py-1.5 pr-4 text-atala whitespace-nowrap">{fn}</td>
      ...
      <section className="rounded-xl border border-border/40 bg-card/30 p-6 space-y-2">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 text-sm text-atala hover:text-atala transition-colors"
        >
      ...
      <div className="flex items-center justify-between pt-4 border-t border-border/40">
        ...
        <Link href="/docs" className="text-sm text-atala hover:text-atala transition-colors">
